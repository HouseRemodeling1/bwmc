                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <input
                                    ...
                                    className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-royal-blue focus:border-transparent outline-none text-sm"
                        ...
                        <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-400">
                                    {formData.published ? "Will be visible on the blog" : "Will be saved as a draft"}
                                </p>
                            </div>
                        </div>
