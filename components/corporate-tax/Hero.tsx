                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-white mb-6">
                            ...
                            <span className="text-xs font-bold tracking-widest uppercase">Corporate Tax Solutions</span>
                        </div>

                        <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-white leading-tight mb-6">
                            Expert Corporate Tax Filing Services That <br />
                            <span className="text-[#f4a460]">Maximize Your Returns</span>
                        </h1>

                        <p className="text-lg text-gray-200 mb-8 max-w-xl leading-relaxed">
                            Trusted by 500+ corporations. On-time filing, maximum deductions, and zero stress. We handle the complexity so you can focus on growth.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-6 mb-10">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-white font-bold">Audit Protection</p>
                                    <p className="text-white/60 text-xs">Full representation</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="p-2 bg-white/10 rounded-lg text-[#f4a460]">
                                ...
                                <div>
                                    <p className="text-white font-bold">On-Time Filing</p>
                                    <p className="text-white/60 text-xs">Never miss a deadline</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="p-2 bg-white/10 rounded-lg text-[#f4a460]">
                                ...
                                <div>
                                    <p className="text-white font-bold">CPA Certified</p>
                                    <p className="text-white/60 text-xs">Expert team</p>
                                </div>
                            </div>
                        </div>
