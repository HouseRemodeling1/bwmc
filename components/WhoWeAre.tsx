        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-block px-4 py-2 bg-sky-blue/10 rounded-full mb-6">
              <span className="text-royal-blue font-bold text-sm tracking-wide uppercase">
                Who we are
              </span>
            </div>

            <h2 className="text-4xl md:text-5xl font-bold text-navy mb-8 leading-tight">
              Trusted & Popular Financial{" "}
              <span className="text-royal-blue">Advisor Dubai, UAE</span>
            </h2>

            <div className="space-y-6 text-lg text-black leading-relaxed mb-8">
              <p>
                BWMC helps you launch, grow, or streamline your business with
                expert financial advisor Dubai. We provide support for business
                setup Dubai and scalable ERP solutions - everything you need, in
                one place.
              </p>
              <p>
                As your strategic partner, we move beyond traditional financial
                consultancy service to offer proactive guidance that anticipates
                challenges and identifies opportunities in the UAE's rapidly
